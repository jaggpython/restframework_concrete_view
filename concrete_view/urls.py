...
urlpatterns = [
    ...
    # path('studentapi/<int:pk>/', views.StudentRetrieveDelete.as_view()), # retrieve and delete

    path('studentapi/<int:pk>/', views.StudentRetrieveUpdateDelete.as_view()), # retrieve and delete, update
